...
if __name__ =='__main__':
    client = Client()
    price = client.request('tickers',None,'btc','usd',None)
    depth = client.request('depth',None,'btc','usd',None)
    trade = client.request('trades',None,'btc','usd',None)
    print(price)
    print(depth)
    print(trade)
