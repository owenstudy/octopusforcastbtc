...
{'tmc': {'price': 6, 'unit': 5}, 'qrk': {'price': 8, 'unit': 6}, 'xzc': {'price': 5, 'unit': 6}, 'xem': {'price': 7, 'unit': 7}, 'mec': {'price': 8, 'unit': 5}, 'etc': {'price': 5, 'unit': 8}, 'dat': {'price': 8, 'unit': 6}, 'doge': {'price': 8, 'unit': 5}, 'ric': {'price': 8, 'unit': 6}, 'ae': {'price': 6, 'unit': 6}, 'cvc': {'price': 7, 'unit': 5}, 'tag': {'price': 8, 'unit': 6}, 'xrp': {'price': 7, 'unit': 6}, 'blk': {'price': 7, 'unit': 7}, 'inf': {'price': 8, 'unit': 6}, 'ardr': {'price': 6, 'unit': 5}, 'vash': {'price': 8, 'unit': 7}, 'ncs': {'price': 8, 'unit': 6}, 'bnt': {'price': 6, 'unit': 6}, 'zcc': {'price': 8, 'unit': 6}, 'xpm': {'price': 8, 'unit': 6}, 'eac': {'price': 0, 'unit': 6}, 'sbtc': {'price': 4, 'unit': 8}, 'bcx': {'price': 8, 'unit': 8}, 'eth': {'price': 4, 'unit': 6}, 'bts': {'price': 7, 'unit': 6}, 'lbtc': {'price': 4, 'unit': 5}, 'bcc': {'price': 4, 'unit': 6}, 'wdc': {'price': 8, 'unit': 6}, 'hlb': {'price': 8, 'unit': 6}, 'knc': {'price': 6, 'unit': 6}, 'dash': {'price': 4, 'unit': 6}, 'sys': {'price': 7, 'unit': 6}, 'nxt': {'price': 7, 'unit': 6}, 'ltc': {'price': 5, 'unit': 6}, 'qash': {'price': 6, 'unit': 6}, 'bcd': {'price': 5, 'unit': 8}, 'mgc': {'price': 8, 'unit': 6}, 'lend': {'price': 8, 'unit': 6}, 'bite': {'price': 8, 'unit': 6}, 'xcn': {'price': 8, 'unit': 6}, 'xlm': {'price': 7, 'unit': 6}}
# btc价格额外的rounding规则
